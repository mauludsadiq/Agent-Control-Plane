-- v0.8.0 decision variants: branching + counterfactual replay
-- Tracks forked workflows and their relationship to the parent.
...
CREATE TABLE IF NOT EXISTS branches (
    ...
    kind                TEXT NOT NULL DEFAULT 'fork',  -- fork | counterfactual
...
VALUES ('004_branches', datetime('now'));
